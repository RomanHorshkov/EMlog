#!/usr/bin/env bash
# =============================================================================
# run_pipeline.sh — the full EMlog pipeline, end to end
#
# author  Roman Horshkov <github.com/RomanHorshkov>
#
# Builds the library, builds+runs the public and private unit test
# suites and the integration test, then builds the Debian package.
